...
LIST=$PROJECT_ROOT/utils/imagenet_selected_pathname5000.txt
CKPT=$PROJECT_ROOT/pretrained
SAVE=$PROJECT_ROOT/features
LABELS=$PROJECT_ROOT/utils/imagenet_selected_label5000.txt
NAMES=$PROJECT_ROOT/data/imagenet/classnames.txt
TYPE=test
BLK=(blk09 blk19 blk29 blk39)
...
#   --model  vitg14 \
#   --head_layers 1 \
#   --out_root $SAVE/$TYPE/dinov2_vitg14 \
#   --blocks 9,19,29,39  \
#   --write_manifest

# python dinov2_feat_pipeline_simple.py replay \
#   --feature_root $SAVE/$TYPE/dinov2_vitg14 \
#   --layer ${BLK[*]} \
#   --labels $LABELS \
#   --weights_root $CKPT \
#   --model  vitg14 \
