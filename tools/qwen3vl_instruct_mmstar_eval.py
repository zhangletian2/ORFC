#!/usr/bin/env python3
"""
Qwen3-VL-8B-Instruct MMStar 评测 (transformers 推理)
...
def main():
    ap = argparse.ArgumentParser("Qwen3-VL-Instruct MMStar Eval")
    ...
    print(f"[config] model=Instruct, seed={args.seed}, sampling={sample_str}, "
    ...
    print(f"  Model: Instruct (no thinking)")
