#!/usr/bin/env python
"""ShareR + freeze R + K4 pure-KD classification on stage2 ImageNet 5k.

Same recipe as launch_shareR_cls_stage2.py except residual K=4.
GPU 6 is occupied; use 0/1/4.
"""
...
def tag_of(layer, K, lmbda, lr):
    ...
    if lmbda == 0.0 and lr == 5e-4:
        ...
        extra = "_lr5e4"
    return f"{layer}_baseK{K}{extra}_res-K4_shareR_clsKD1_ep50_stage2"
