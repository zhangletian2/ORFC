...
FIG_DIR = os.path.join(ROOT, 'figures_aitisa')

COND_COLORS = {'identity': '#777', 'opq': '#286CA0'}
COND_LABELS = {'identity': 'Identity', 'opq': 'Ours'}
