...
def build(anchor, device, max_images=None, log=print):
    started = time.time()
    ...
    meta = {"plan": "v12", "stage": "opq_u0_all_modes_kmeans",
            ...
            "all_modes_kmeans": True, "orthogonality": orth,
...
def load_checked(anchor, device):
    ...
    if meta["images"] != C.N_TRAIN or not meta["all_modes_kmeans"]:
...
def main():
    ...
    target = C.init_dir(anchor) / "codec.pt"
